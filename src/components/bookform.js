  ...
  return (
    <div className="centered-container">
      <form className="input" onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          <input type="text" placeholder="Info" id="nameInput" className="form-control" value={info} onChange={(e) => setCategory(e.target.value)} required />
        </div>
        <div className="mb-3">
          <input type="text" placeholder="Category" id="nameInput" className="form-control" value={category} onChange={(e) => setInfo(e.target.value)} required />
        </div>
